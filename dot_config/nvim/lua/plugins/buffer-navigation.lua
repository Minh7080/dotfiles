    ...
    {
        {
            ...
            config = function()
                ...
                -- REQUIRED setup with default settings
                harpoon:setup({})

                -- Keymaps using Harpoon 2's modules
                vim.keymap.set("n", "<leader>a", function() harpoon:list():add() end)
                vim.keymap.set("n", "<C-e>", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end)

                -- Navigation using UI module
                ...
                -- Cycle through marks
                vim.keymap.set("n", "<A-i>", function() harpoon:list():prev() end)
                vim.keymap.set("n", "<A-o>", function() harpoon:list():next() end)
            end,
        }
    },
